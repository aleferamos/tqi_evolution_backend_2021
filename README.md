...
Todas as requisições é feitas a partir do endereço: alefe.vps-kinghost.net:8080/sistema-credito | Para agilizar os teste, hospedei a api em um container da minha vps.
